...
//	@PutMapping("/alumni/updateAlumni")
//	public ResponseEntity<Alumni> updateAlumni(@RequestParam Long alroll, @RequestParam String alpassword,@RequestBody Alumni alumni) {
//		return new ResponseEntity<Alumni>(alumniService.changePassword(alroll, alpassword, alumni), HttpStatus.OK);
//	}
